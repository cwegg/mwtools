...
def test_getcolumn_lower():
    ...
    nptest.assert_equal(mwtools.xmatch._get_column_from_keylist(fake_coordinate_table, ['ra']), fake_ras)
...
def test_getcolumn_raises_error():
    ...
    with pytest.raises(ValueError):
        mwtools.xmatch._get_column_from_keylist(fake_coordinate_table, ['RA', 'DEC'])
...
def test_make_coordinate_table():
    ...
    coordinate_table = mwtools.xmatch._make_coordinate_table(fake_coordinate_table)
